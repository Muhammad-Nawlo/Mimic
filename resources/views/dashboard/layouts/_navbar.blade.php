<header class="main-header">
    ...
    <a href="{{route('dashboard.home')}}" class="logo">
        <span class="logo-mini">Mimic</span>
        <span class="logo-lg">Mimic</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <ul class="menu" style="background-color: #fd777c;">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @if(auth()->user()->remember_token !=null)
                            <li class="user-footer">
                                <a href="{{ route('dashboard.hotelLogout') }}" class="btn btn-default btn-flat">@lang('site.Logout_To_Admin')</a>
                            </li>
                        @endif
