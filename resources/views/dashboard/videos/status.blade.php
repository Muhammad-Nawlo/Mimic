        ...
        <div class="modal-dialog" role="dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('dashboard.changeVideoeStatus')}}" method="POST">
                        @csrf
                                                ...
                                                @if($reason->type=='client')
                                                    <div class="direct-chat-msg">
                                                        <a href="{{route('dashboard.client',$row->client_id)}}">
                                                            <img class="direct-chat-img" src="{{$row->client->image_path}}" alt="message user image">
                                                        </a>    
